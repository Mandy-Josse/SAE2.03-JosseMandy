...
let HOST_URL = "http://mmi.unilim.fr/~josse10/TP5/client/"; // CHANGE THIS TO MATCH YOUR CONFIG
...
DataMenu.delete = async function (fdata) {
    let answer = await fetch(HOST_URL + "/server/script.php?todo=delete&semaine=" + week + "&jour=" + day);
    let data = await answer.json();
    return data;
